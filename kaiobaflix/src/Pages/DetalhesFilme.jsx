    ...
    <div className="bg-white min-h-screen p-10 pt-24">
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
          ...
          <div className="p-6">
            <h1 className="text-3xl font-bold text-black mb-2">{filme.title}</h1>
            <p className="text-black mb-4">{filme.overview}</p>
            <p className="text-black">Avaliação: {filme.vote_average}</p>
          </div>
        </div>
      </div>
    </div>
